        ...
        <div class="card">
            ...
            <div class="body">
                <?php echo form_open_multipart(site_url($this->uri->segment(1).'/'.$this->uri->segment(2).'/'.'save'), array('class' => 'form-horizontal', 'id' => 'form-create', 'role'=>"form")); ?>
                    ...
                    <?php if(! empty($id)) { ?> <!-- in case of update e_bookings -->
                    ...
                    <div class="row clearfix" id="customers_label">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('e_bookings_customer', 'customers', array('class'=>'customers')); ?>
                        </div>
                        <div class="col-md-10">
                    ...
                    <div class="row clearfix" id="event_types_label">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('e_bookings_event_type', 'event_types', array('class'=>'event_types')); ?>
                        </div>
                        <div class="col-md-10">
                            <div class="form-group">
                                <div class="form-line">
                                ...
                                <div class="help-info"><span id="event_types_loader"></span></div>
                            </div>
                        </div>
                    </div>

                    <div class="row clearfix" id="event_label">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('e_bookings_event_selected', 'selected_event', array('class'=>'selected_event')); ?>
                        </div>
                        <div class="col-md-8">
                            <h4></h4>
                    ...
                    <div class="row clearfix" id="event_calendar">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('e_bookings_event_select', 'select_event', array('class'=>'select_event')); ?>
                        </div>
                        <div class="col-md-10">
                            <!-- THE CALENDAR -->
                            <div id="calendar"></div>
                    ...
                    <div class="row clearfix members-toggle">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('e_bookings_members', 'members', array('class' => 'col-sm-2 control-label')); ?>
                        </div>
                        <div class="col-sm-10">
                            <div class="row">
                                <div class="col-sm-3">
                                    <button type="button" class="btn btn-default waves-effect add_member_button"><i class="material-icons">add</i><?php echo lang('e_bookings_members_add'); ?></button>
                                </div>
                                <br><br>
                            </div>
                            <div class="row">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6" id="fees_label">
                            <div class="row clearfix">
                                ...
                                <?php echo lang('e_bookings_fees', 'fees', array('class'=>'fees')); ?>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="form-line">
                        ...
                        <div class="col-md-6" id="net_fees_label">
                            <div class="row clearfix">
                                <div class="col-md-4 form-control-label">
                                    <?php echo lang('e_bookings_net_fees', 'net_fees', array('class'=>'net_fees')); ?>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="form-line">
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                            <div class="row clearfix">
                                <div class="col-md-4 form-control-label">
                                <?php echo lang('e_bookings_payment_type', 'payment_type', array('class'=>'payment_type')); ?>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="form-line">
                        ...
                        <div class="col-md-6">
                            <div class="row clearfix">
                                <div class="col-md-4 form-control-label">
                                    <?php echo lang('e_bookings_payment_status', 'payment_status', array('class'=>'payment_status')); ?>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="form-line">
...
<script type="text/javascript">
    var selectedEvent      = '<?php echo !empty($selected_event) ? json_encode($selected_event) : null; ?>';
</script>