...
class Ion_auth
{
	 ...
	 **/
	public function is_non_admin($id=false)
	{
		$this->ion_auth_model->trigger_events('is_non_admin');

		$non_admin_group = $this->config->item('default_group', 'ion_auth');
	 ...
	 * @author Deepak Panwar
	 **/
	public function get_users_by_group($group_id=false)
	{
		$this->ion_auth_model->trigger_events('get_users_by_group');

		return $this->users_in_group($group_id);
	}


	/* =============================/=/=/=/= END CUSTOM METHODS BY DEEPAK =/=/=/=/===============================*/
