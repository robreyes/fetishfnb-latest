    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <!-- Delete Button -->
                <?php if(!empty($id)) { echo '<a role="button" onclick="ajaxDelete('.$id.', ``, `'.lang('menu_course_category').'`)" class="btn btn-default btn-circle waves-effect waves-circle waves-float pull-right"><i class="material-icons">delete_forever</i></a>'; } ?>
            </div>
            <div class="body">
                <?php echo form_open_multipart(site_url($this->uri->segment(1).'/'.$this->uri->segment(2).'/'.'save'), array('class' => 'form-horizontal', 'id' => 'form-create', 'role'=>"form")); ?>
                    ...
                    <?php if(! empty($id)) { ?> <!-- in case of update course_categories -->
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                    <?php } ?>
                    
                    <div class="row clearfix">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('course_categories_level', 'level', array('class'=>'level')); ?>
                        </div>
                        <div class="col-md-10">
                                ...
                                <div class="picture-container">
                                    <div class="picture-square width-50">
                                        <?php if(! empty($c_image)) { ?>
                                            <img id="c_image" src="<?php echo base_url('upload/course_categories/images/'.image_to_thumb($c_image)); ?>" class="img-responsive">
                                        <?php } else { ?>
                            ...
                            <div class="form-group">
                                <div class="picture-container">
                                    <div class="picture-square width-25">
                                        <?php if(! empty($c_icon)) { ?>
                                            <img id="c_icon" src="<?php echo base_url('upload/course_categories/icons/'.image_to_thumb($c_icon)); ?>" class="img-responsive">
                                        <?php } else { ?>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="help-info text-warning">*<?php echo lang('course_categories_status_alert') ?></div>
                            </div>
                        </div>
                    </div>
