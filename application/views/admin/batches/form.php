    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="header">
                ...
                <!-- Delete Button -->
                <?php if(!empty($id)) { echo '<a role="button" onclick="ajaxDelete('.$id.', ``, `'.lang('menu_batch').'`)" class="btn btn-default btn-circle waves-effect waves-circle waves-float pull-right"><i class="material-icons">delete_forever</i></a>'; } ?>
            </div>
            <div class="body">
                <?php echo form_open_multipart(site_url($this->uri->segment(1).'/'.$this->uri->segment(2).'/'.'save'), array('class' => 'form-horizontal', 'id' => 'form-create', 'role'=>"form")); ?>
                    ...
                    <?php if(! empty($id)) { ?> <!-- in case of update batches -->
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="help-info"><?php echo lang('batches_title_eg') ?></div>
                            </div>
                        </div>
                    </div>    
                    <div class="row clearfix">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('batches_courses', 'courses', array('class'=>'courses')); ?>
                        </div>
                        <div class="col-md-10">
                            <div class="form-group">
                                <div class="form-line">
                                ...
                                <div class="help-info"><?php echo lang('batches_courses_eg') ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('batches_tutors', 'tutors', array('class'=>'tutors')); ?>
                        </div>
                        <div class="col-md-10">
                            <div class="form-group">
                                <div class="form-line">
                                ...
                                <div class="help-info"><?php echo lang('batches_tutors_eg') ?></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                            <div class="row clearfix">
                                ...
                                <?php echo lang('batches_fees', 'fees', array('class'=>'fees')); ?>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="form-line">
                                        ...
                                        <div class="help-info"><?php echo lang('batches_fees_eg').' ('.$this->settings->default_currency.')'; ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="row clearfix">
                                <div class="col-md-4 form-control-label">
                                    <?php echo lang('batches_capacity', 'capacity', array('class'=>'capacity')); ?>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="form-line">
                                        ...
                                        <div class="help-info"><?php echo lang('batches_capacity_eg') ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                            <div class="row clearfix" id="start_end_date_select">
                                <div class="col-md-4 form-control-label">
                                    <?php echo lang('batches_start_end_date', 'start_end_date', array('class'=>'start_end_date')); ?>
                                </div>
                                <div class="col-md-8">
                                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="row clearfix">
                                <div class="col-md-4 form-control-label">
                                    <?php echo lang('menu_batch', 'batches_type', array('class'=>'batches_type')); ?>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <?php echo lang('batches_recurring', 'recurring', array('class'=>'recurring')); ?>
                                    <div class="help-block"><?php echo lang('batches_recurring_eg') ?>&nbsp;&nbsp;<i class="material-icons pointer-elem help-recursive">help</i></div>
                                </div>        
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row clearfix" id="weekdays_select">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('batches_weekdays', 'weekdays', array('class' => 'weekdays')); ?>
                        </div>
                        <div class="col-md-10">
                            ...
                            <?php } ?>
                            <div class="help-block"><?php echo lang('batches_weekdays_eg') ?></div>
                        </div>        
                    </div>
                    
                    <div class="row clearfix" id="recurring_type_select">
                        <div class="col-md-2 form-control-label">
                            <?php echo lang('batches_recurring_types', 'recurring_type', array('class' => 'recurring_type')); ?>
                        </div>
                        <div class="col-md-10">
                            ...
                            <?php } ?>
                            <div class="help-block"><?php echo lang('batches_recurring_types_ie') ?></div>
                        </div>        
                    </div>
                    ...
                    <div class="row clearfix">
                        <div class="col-md-6">
                            <div class="col-md-offset-2 input-group"> 
                                <?php echo lang('batches_start_time', 'start_time_1', array('class' => 'col-md-2 start_time_1')); ?>
                        ...
                        <div class="col-md-6">
                            <div class="col-md-offset-1 input-group"> 
                                <?php echo lang('batches_end_time', 'end_time_1', array('class' => 'col-md-1 start_time_1')); ?>
                    ...
                    <div class="row clearfix">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <div class="help-info text-warning">*<?php echo lang('batches_status_alert') ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="row clearfix">
...
<script type="text/javascript">
    var tutors      = <?php echo isset($_POST['tutors']) ? json_encode($_POST['tutors']) : '0'; ?>;
</script>