			...
			<table>
				<tr>
					<td>
						...
						<a style=" color: #fff; background: #000;padding: 10px 25px;text-decoration: none; margin-top: 10px;display: inline-block;" href="<?php echo base_url(). 'auth/activate/'.$id.'/'.$activation;?>"><?php echo lang('email_activate_link');?></a>
