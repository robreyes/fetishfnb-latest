          ...
          <div class="card">
              ...
              <div class="body">
                  <?php echo form_open_multipart(site_url($this->uri->segment(1).'/'.$this->uri->segment(2).'/'.'save'), array('class' => 'form-horizontal', 'id' => 'form-create', 'role'=>"form")); ?>
                      ...
                      <div id="timeslothidden">
                        <?php if(!empty($timeslots)) foreach ($timeslots as $key => $timeslot): ?>
                          <input type="hidden" name="timeslots_start_time[]" value="" class="timeslot-hidden" data-timeslot="<?php echo bcadd($key, 1);?>">
                          <input type="hidden" name="timeslots_end_time[]" value="" class="timeslot-hidden" data-timeslot="<?php echo bcadd($key, 1);?>">
                          <input type="hidden" name="timeslots_slot[]" value="" class="timeslot-hidden" data-timeslot="<?php echo bcadd($key, 1);?>">
                        <?php endforeach; ?>
                      </div>
                      ...
                      <div class="row clearfix" id="timeslot_type_select">
                        <div class="col-md-6">
                            <div class="col-md-4 form-control-label">
                                <?php echo lang('e_bookings_enable_timeslot', 'timeslot', array('class'=>'timeslot')); ?>
                            </div>
                            <div class="col-md-8">
                              <input type="checkbox" id="timeslot" name="timeslot" value="1" class="filled-in" <?php echo isset($_POST['timeslot']) ? ($_POST['timeslot'] ? 'checked' : '') :'' ; ?>>
                              <?php echo lang('e_bookings_custom_timeslot', 'timeslot', array('class'=>'timeslot')); ?>
                              <div class="help-block"><?php echo lang('e_bookings_custom_timeslot_sg') ?></div>
                            </div>
                        </div>
                        <div id="timeslot-toggler" class="col-md-6">
                          <a class="timeslot_add btn" href="JavaScript:void(0);" data-pressed="1">Add Timeslot</i></a>
                        </div>
                      </div>

                      <div class="row clearfix" id="timeslot_timepicker">
                        <?php if(!empty($timeslots)) foreach ($timeslots as $key => $timeslot){ ?>
                        <div class="timeslot_select"  data-timeslot="<?php echo bcadd($key, 1)?>">
                          <div class="col-md-2 form-control-label">
                              <?php echo lang('events_start_time', 'start_time_1', array('class' => 'start_time_1')); ?>
                          </div>
                          <div class="timeslot-start col-md-4 padding-0">
                              <div class="timeslot_form col-sm-12 input-group">
                                <div class="col-sm-4 input-join padding-0"><?php echo form_dropdown($timeslot['timeslot_start_time_1']);?></div>
                                <div class="col-sm-4 input-join padding-0"><?php echo form_dropdown($timeslot['timeslot_start_time_2']);?></div>
                                <div class="col-sm-4 input-join padding-0"><?php echo form_dropdown($timeslot['timeslot_start_time_3']);?></div>
                              </div>
                          </div>
                          <div class="col-md-1 form-control-label">
                              <?php echo lang('events_end_time', 'end_time_1', array('class' => 'end_time_1')); ?>
                          </div>
                          <div class="timeslot-end col-md-5 padding-0">
                            <div class="timeslot_form col-md-12 input-group">
                              <div class="col-sm-3 input-join padding-0"><?php echo form_dropdown($timeslot['timeslot_end_time_1']);?></div>
